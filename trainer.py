...
import numpy as np
import torch
from ppo.ppo.replay_memory import Transition
from ppo.ppo.agent import PPOAgent
import warnings
        ...
        for episode in range(self.episodes):
            ...
            while not done:
                ...
                if done:
                    ...
                    print(
                        f"Episode: {episode},\tScore: {score},\tMean of last 100: {avg}"
                    )
