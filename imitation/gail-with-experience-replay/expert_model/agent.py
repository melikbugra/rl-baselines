...
import numpy as np
import torch
from expert_model.replay_memory import ReplayMemory, PrioritizedReplayMemory
from expert_model.mlp import MLP
import torch.optim as optim
import random
import math
import matplotlib.pyplot as plt
from expert_model.replay_memory import Transition
...
class DQNAgent:
    ...
    def plot_scores(self, show_result=False):
        ...
        if len(scores) >= 100:
            ...
            means = torch.cat((torch.ones(99)*scores[:100].mean(), means))
    ...
    def evaluate(self, env_name: str, episodes: int):
        ...
        env = gym.make(env_name, maze=maze, max_steps=500)
        scores = []
